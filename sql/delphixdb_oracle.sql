...
SET DEFINE OFF;
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Woody','Evans','Solution Architects','Hoboken');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Jeff','Zeisler','Solution Architects','Menlo Park');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Dr. Jeff','Wootton','Lyrical Rap Studies','Reston');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Dino','Konstantinos','Sales','Fantasyland');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Ted','Girard','Sales','Bethesda');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Adam','Bowen','No Sleep Till','Brooklyn');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Adam','Bowen','Solution Architects','Ashland');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Luther','Vandross','Superstar','NYC');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Ted','Girard','Sales','Bethesda');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Jude','Seth','Solution Architects','DK');
Insert into DELPHIXDB.EMPLOYEES (FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values ('Darth','Vader','Imperial Army','Death Star');
