...
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (1,'Woody','Evans','Solution Architects','Hoboken');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (2,'Jeff','Zeisler','Solution Architects','Menlo Park');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (3,'Dr. Jeff','Wootton','Lyrical Rap Studies','Reston');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (4,'Dino','Konstantinos','Sales','Fantasyland');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (5,'Ted','Girard','Sales','Bethesda');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (6,'Adam','Bowen','No Sleep Till','Brooklyn');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (7,'Adam','Bowen','Solution Architects','Ashland');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (8,'Luther','Vandross','Superstar','NYC');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (9,'Ted','Girard','Sales','Bethesda');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (10,'Jude','Seth','Solution Architects','DK');
Insert into EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,DEPT_NAME,CITY) values (11,'Darth','Vader','Imperial Army','Death Star');
